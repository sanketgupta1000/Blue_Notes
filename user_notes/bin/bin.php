...
<body>
    ...
    <main>
        ...
        <!-- note container for binned notes-->
        <div class="container notes-container my-3 my-md-4 my-lg-5" id="binnededNotesContainer">

            <div class="row">
                <div class="col-12">
                    <h6 class="text-secondary">Bin</h6>
                </div>
            </div>

            <div class="row gy-4" id="binnedNotesContainerRow"></div>

        </div>

    </main>

    <!-- making a modal for showing note -->
    <aside>
